          ...
          <div className="flex flex-col items-center md:items-start gap-6">
            ...
            <div className="flex gap-4 mt-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 bg-white text-black font-medium px-5 py-2 rounded shadow hover:bg-gray-100"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 bg-white text-[#0A66C2] font-medium px-5 py-2 rounded shadow hover:bg-gray-100"
              >
